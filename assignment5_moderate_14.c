/* Assignment 5 - Moderate Variation 14
 * Dynamic number of integer readings with validation
 * File: assignment5_moderate_14.c
 */
#include <stdio.h>
#include <stdlib.h>
...
int main() {
    int n;
    printf("Assignment5 Moderate #14 - Enter number of readings (1-50): ");
    if (scanf("%d", &n) != 1 || n <= 0 || n > 50) { printf("Invalid number\n"); return 1; }
